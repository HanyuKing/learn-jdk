/********************************** 入库单 **********************************/
DROP
  TABLE IF EXISTS `erp_stock_in_order`;
CREATE TABLE `erp_stock_in_order` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT,
  `stock_in_order_id` VARCHAR (20) NOT NULL COMMENT '入库单号',
...
DROP
  TABLE IF EXISTS `erp_stock_in_order_item`;
CREATE TABLE `erp_stock_in_order_item` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT,
  `stock_in_order_id` VARCHAR (20) NOT NULL COMMENT '入库单号',
  `ssu_id` BIGINT (20) NOT NULL DEFAULT '0' COMMENT '商品id',
  `itemId` VARCHAR (128) NOT NULL COMMENT '商品编码',
  `itemName` VARCHAR (128) DEFAULT NULL COMMENT '商品名称',
...
/********************************** 出库单 **********************************/
DROP
  TABLE IF EXISTS `erp_stock_out_order`;
...
DROP
  TABLE IF EXISTS `erp_stock_out_order_item`;
CREATE TABLE `erp_stock_out_order_item` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `stock_out_id` VARCHAR (20) NOT NULL COMMENT '出库单号',
  ...
  `confirm_number` INT (10) DEFAULT NULL COMMENT '确认出库数量',
...
/********************************** 运单 ****************************************/
DROP
  TABLE IF EXISTS `erp_logistics_order`;
CREATE TABLE `erp_logistics_order` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `stock_out_id` VARCHAR (20) NOT NULL COMMENT '出库单号',
  `logistics_order_id` VARCHAR (20) NOT NULL COMMENT '运单号',
...
DROP
  TABLE IF EXISTS `erp_logistics_order_item`;
CREATE TABLE `erp_logistics_order_item` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `logistics_order_id` VARCHAR (20) NOT NULL COMMENT '运单号',
  `ssu_id` BIGINT (20) NOT NULL COMMENT '商品id',
  `product_code` VARCHAR (200) DEFAULT NULL COMMENT '商品编码',
...
/********************************** log ****************************************/
DROP
  TABLE IF EXISTS `erp_stock_in_order_log`;
CREATE TABLE `erp_stock_in_order_log` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT,
  `stock_in_id` VARCHAR (20) NOT NULL COMMENT '入库单号',
  `status` VARCHAR (20) NOT NULL COMMENT '入库单状态',
  `operator` BIGINT (20) DEFAULT NULL COMMENT '操作人id',
  `content` text COMMENT '入库单变化内容',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_stock_in_order_id` (`stock_in_id`)
) ENGINE = INNODB DEFAULT CHARSET = utf8 COMMENT = '入库单操作日志';
DROP
  TABLE IF EXISTS `erp_stock_out_log`;
CREATE TABLE `erp_stock_out_log` (
  `id` BIGINT (20) NOT NULL AUTO_INCREMENT COMMENT '主键',
